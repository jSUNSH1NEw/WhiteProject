...
// /// @author cd33
// contract TESTS_WarenVestingERC1155 is Ownable, ERC1155Holder, ReentrancyGuard {
//     using SafeERC20 for WarenERC20;

//     TESTS_Waren public warenERC1155;
...
//      * @param _tokenAmount Number of tokens to stake to check.
//      */
...
//         require(notPaused, "Unstaking and Rewards unavailable for the moment");
//         require(_tokenId > 0 && _tokenId < 5, "NFT doesn't exists");
//         require(
...
//      * @param tokenAmount Number of tokens to stake.
//      */
...
//      * @param tokenAmounts Numbers of tokens to stake.
//      */
...
//      * @param _tokenAmount Number of tokens to stake.
//      */
...
//         if (item.tokenId == 1 || item.tokenId == 2) {
